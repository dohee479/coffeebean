...
<body>
 <header>
    ...
    <nav>
      <ul>
        <li>
          <a class="country" href="${pageContext.request.contextPath}/product/country">나라</a>
          <div class="hidden-menu">
            <a href="${pageContext.request.contextPath}/product/country">케냐</a>
            <a href="${pageContext.request.contextPath}/product/country">에티오피아</a>
            <a href="${pageContext.request.contextPath}/product/country">브라질</a>
            <a href="${pageContext.request.contextPath}/product/country">예멘</a>
            <a href="${pageContext.request.contextPath}/product/country">베트남</a>
          </div>
        </li>
        <li>
          <a class="taste" href="${pageContext.request.contextPath}/product/flavor">맛/향</a>
          <div class="hidden-menu">
            <a href="${pageContext.request.contextPath}/product/flavor">달콤쌉싸름</a>
            <a href="${pageContext.request.contextPath}/product/flavor">고소함</a>
            <a href="${pageContext.request.contextPath}/product/flavor">묵직하고 달콤한 여운</a>
            <a href="${pageContext.request.contextPath}/product/flavor">은은하고 편안함</a>
            <a href="${pageContext.request.contextPath}/product/flavor">상큼한 산미</a>
          </div>
        </li>
      </ul>
    </nav>
