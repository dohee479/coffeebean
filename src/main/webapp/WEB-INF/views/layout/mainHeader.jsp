...
<body>
  <header>
    <div class="logo"><a href="main.html"><img src="${pageContext.request.contextPath}/resources/images/header/logo.png"></a></div>
    <nav>
      <ul>
        <li>
    ...
    <div class="user-menu">
      ...
      <div class="user-item"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/header/cart.png" style="height:24px"></a></div>
