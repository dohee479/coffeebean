...
<div class="find-body">
           <div class="content">
                <div class="mt-4">
                    ...
                    <div class="lastbutton"><button class="button1" data-toggle="modal" data-target="#findidmodal">아이디 찾기</button></div>
                </div>
                <div class="mt-4">
                    <table class="table_1">
                        <h6 class="table_h">비밀번호 찾기</h6>
                        <tr>
                    ...
                    <div class="lastbutton"><button class="button2" data-toggle="modal" data-target="#findpwdmodal">비밀번호 찾기</button></div>
                </div>
           </div> 
        </div>
                ...
                <div class="modal-body">
                  <div>
                      <table class="table_1">
                          ...
                          <tr><th>이메일</th><td><span>dnsgh9177@naver.com</span><button class="small_button">발송</button></td></tr>
                      </table>
                      <span>회원 이메일로 아이디를 보내드립니다.</span>
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" style="background-color: rgb(51,51,51);">로그인</button>
                ...
                <div class="modal-body">
                    <div>
                        <table class="table_1">
                            ...
                            <tr><th>이메일</th><td><span>dns*****@naver.com</span><button class="small_button">발송</button></td></tr>
                        </table>
                        <span>회원 이메일로 임시 비밀번호를 보내드립니다.<br>임시 비밀번호로 로그인 후, 새 비밀번호로 변경하시기 바랍니다.</span>
                    </div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" style="background-color: rgb(51,51,51);">로그인</button>
